...
object DetectionRules {
    ...
    // Broad on purpose: within the YouTube app, any "reel*"/"shorts*" view-id means the Shorts
    // player is up. Normal watch pages use "watch_*"/"player_*" and don't contain these.
    val youtubeShorts = listOf("reel", "shorts")
